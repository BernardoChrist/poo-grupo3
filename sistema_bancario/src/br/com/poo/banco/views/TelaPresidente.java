	...
	public TelaPresidente(Funcionario funcionario) {
		...
		btnContAge.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Map<String, Integer> contasPorAgencia = new HashMap<>(); // Mapa para armazenar o número de contas de cada agência
		        ...
		        try {
		            ...
		            while ((line = reader.readLine()) != null) {
		                ...
		                if (dados.length >= 6 && (dados[0].equalsIgnoreCase("Poupanca") || dados[0].equalsIgnoreCase("Corrente"))) {
		        ...
		        for (Map.Entry<String, Integer> entry : contasPorAgencia.entrySet()) {
		            ...
		            relatorio.append("\nAgência: ").append(agencia).append("\nTotal de Contas: ").append(totalContas).append("\n");
		        }
		...
		btnLisDire.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(null, relatorio.toString(), "Relatório de Diretores",
		...
		btnInfoClie.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				trC.setVisible(true);
				trC.setLocationRelativeTo(null);
			}
		});
		...
		btnCapitalArmazenado.addActionListener(new ActionListener() {
			static final String PATH_BASICO = "./temp/";
			static final String EXTENSAO = ".txt";

			public void actionPerformed(ActionEvent e) {
				double totalSaldoClientes = 0.0;
				double totalPagamentosFuncionarios = 0.0;
				...
				try {
					...
					while ((line = reader.readLine()) != null) {
						...
						if (dados.length >= 4
							...
							totalSaldoClientes += Double.parseDouble(dados[3]);
						} else if (dados.length >= 5 && dados[0].equalsIgnoreCase("Gerente")) {
							totalPagamentosFuncionarios += Double.parseDouble(dados[1]);
						} else if (dados.length >= 5 && dados[0].equalsIgnoreCase("Diretor")) {
							totalPagamentosFuncionarios += Double.parseDouble(dados[1]);
						} else if (dados.length >= 5 && dados[0].equalsIgnoreCase("Presidente")) {
							totalPagamentosFuncionarios += Double.parseDouble(dados[1]);
						}
					}
					reader.close();
				...
				double capital = totalSaldoClientes - totalPagamentosFuncionarios;
				NumberFormat formatter = NumberFormat.getCurrencyInstance(new Locale("pt", "BR"));
				String capitalFormatado = formatter.format(capital);
				JOptionPane.showMessageDialog(null, "O capital do banco é: " + capitalFormatado);
