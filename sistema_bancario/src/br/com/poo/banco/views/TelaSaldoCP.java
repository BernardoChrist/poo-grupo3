...
public class TelaSaldoCP extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TelaSaldoCP frame = new TelaSaldoCP();
	...
	public TelaSaldoCP() {
		...
		JLabel TextPainelCliente = new JLabel("Saldo Conta Poupança");
		TextPainelCliente.setBounds(158, 10, 140, 15);
		...
		RendimentosButton.setBounds(212, 183, 101, 21);
		contentPane.add(RendimentosButton);
