...
public class TelaCP extends JFrame {
	...
	public TelaCP() {
		...
		JLabel TextNomeCliente = new JLabel("Nome do cliente");
		TextNomeCliente.setBounds(92, 46, 85, 13);
